...
translate italian int_bayonets_etiquettes_5abdd994:

    # "Oh, the middle pages of the book have been cut out to form a secret compartment."
    "Oh, le pagine centrali del libro sono state ritagliate per formare un compartimento segreto."

# game/1000_base_game/game/items/bayonets_etiquettes.rpy:17
translate italian int_bayonets_etiquettes_72e369c2:
    ...
    "Chi ha fatto questo probabilmente ha pensato che nessuno sarebbe stato abbastanza annoiato da leggere attraverso il capitolo chiamato \"Burette & Pincette: il famoso francese Lab-Cooked Omelette\"."

# game/1000_base_game/game/items/bayonets_etiquettes.rpy:18
translate italian int_bayonets_etiquettes_d9a1bdd2:

    # "Well, that chapter would certainly have been useful, but maybe this will be too?"
    "Ebbene, quel capitolo sarebbe stato certamente utile, ma forse anche questo?"

# game/1000_base_game/game/items/bayonets_etiquettes.rpy:22
translate italian int_bayonets_etiquettes_445ee9ef:
...
translate italian int_bayonets_etiquettes_5528e6c8:

    # "The French tracked down the author of this book, but couldn't stab him to death. Their stilettos weren't sharp enough."
    "I francesi hanno rintracciato l'autore di questo libro, ma non sono riusciti a fargli morire; i loro stiletti non erano abbastanza affilati."

# game/1000_base_game/game/items/bayonets_etiquettes.rpy:24
translate italian int_bayonets_etiquettes_09aef508:

    # "He arrived at the hospital with minor bruising and a smell of freshly baked baguettes."
    "Arrivò all'ospedale con piccoli lividi e un odore di baguette appena sfornate."
